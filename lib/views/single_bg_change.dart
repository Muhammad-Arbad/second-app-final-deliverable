                          ...
                          moveableImagesOnImage != null
                              ? Positioned.fill(
                                  child: MoveableWidget(
                                    item: moveableImagesOnImage == null
                                        ? IgnorePointer()
  ...
  getImageAndFreehandCropping(ImageSource media) async {
    ...
    if (status.isGranted) {
      ...
      if (selectedImage != null) {
        selectedImageFromGallery = await Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => ImageCropper(imageFile: img)));

        if (widget.bannerModel.bannerName == "Echo photos" &&
  ...
  getImageAndCropByShape(ImageSource media) async {
    ...
    if (selectedImage != null) {
      selectedImageFromGallery = await Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ShapeImageCropper(imageFile: img)));
